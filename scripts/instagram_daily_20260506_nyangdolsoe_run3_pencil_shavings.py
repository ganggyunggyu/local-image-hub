...
base_prompt = (
    ...
    "sitting at a quiet wooden desk in late afternoon, carefully emptying a small transparent manual pencil sharpener shavings compartment into a tiny paper bin, "
    "curled pale cedar pencil shavings, a few short pencils, graphite dust on a plain cloth, tiny cleaning brush, neat practical stationery maintenance scene, "
...
payload = {
    ...
    "style": None,
    "save_to_disk": True,
    "filename": "ig_20260506_run3_pencil_shavings_fresh.webp",
}
...
webp_path = OUT_DIR / f"nyangdolsoe_pencil_shavings_nai_{seed}.webp"
