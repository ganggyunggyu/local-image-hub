...
OUT_DIR = Path(__file__).parent.parent / "outputs" / "20260509_instagram_daily_nyangdolsoe_run3_vacuum_brushroll"
...
base_prompt = (
    ...
    "kneeling beside a compact cordless vacuum cleaner on a clean woven mat, square composition, upper body and careful hands visible, "
    "removing tangled hair and thread from a detached vacuum brush roll with small safety scissors and tweezers, "
    "tiny dust curls collected on a paper towel, removable end cap, soft maintenance brush, miniature sealed server cube on a nearby low shelf, calm practical expression, "
    "everyday household maintenance scene, tactile bristle and plastic details, no readable text, no logo, no watermark, masterpiece, best quality"
)
style_suffix = (
    "delicate anime illustration with translucent washi paper texture and fine ink lines, muted teal, dusty coral, ivory, and deep navy palette, "
    "soft side light through a quiet room, neat composition, crisp hand details, practical slice of life, subtle color-pencil grain, editorial poster look without text"
)
...
negative_prompt = (
    ...
    "mouse wheel, mouse pad, laundry lint filter, washing machine, iron, placemat, phone screen, tablet screen, keyboard, monitor with text, brand logo, photorealistic, horror, muddy colors, overexposed, cluttered crowd, plain white background, flat empty scene, asymmetrical eyes, distorted face"
)
...
webp_path = OUT_DIR / f"nyangdolsoe_vacuum_brushroll_washi_nai_{seed}.webp"
...
jpg_path = OUT_DIR / f"nyangdolsoe_vacuum_brushroll_washi_nai_{seed}_upload.jpg"
