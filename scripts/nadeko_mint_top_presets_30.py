"""NAI batch: Nadeko (mint hair) x top presets (30 images).
...
OUTPUT_DIR = Path(__file__).parent.parent / "outputs" / f"{TODAY}_nadeko_mint_top_presets_30"
...
MINT_HAIR = "1.4::mint green hair::, 1.15::light green hair::, -1.2::orange hair::"
...
def build_jobs() -> list[Job]:
    ...
    for style_index, style in enumerate(TOP_STYLES):
        for i in range(per_style):
            ...
            prompt = (
                f"1girl, {CHAR_BASE}, {MINT_HAIR}, {outfit}, {scene}, {pose}, {expression}{extra}, "
...
async def main() -> None:
    ...
    print("nadeko mint top presets 30 (NAI)", flush=True)
