...
OUT_DIR = Path(__file__).parent.parent / "outputs" / "20260510_instagram_daily_nyangdolsoe_run1_shoelace_aglet"
...
base_prompt = (
    ...
    "sitting beside a low wooden entryway bench in calm late-morning light, square composition, upper body and careful adult hands visible, "
    "repairing a frayed shoelace tip on a clean navy sneaker, one hand holding the lace end straight, the other wrapping a tiny clear heat-shrink tube around the aglet, "
    "small scissors, plain tweezers, soft cloth, and an unlabeled maintenance tray nearby, miniature sealed server cube tucked on the shelf with no markings, calm focused expression, "
    "everyday object maintenance scene, tactile woven shoelace fibers and matte rubber sole details, no readable text, no logo, no watermark, masterpiece, best quality"
)
style_suffix = (
    "nocturne cyanotype anime illustration with fine linocut linework, deep indigo, warm cream, and small copper accent palette, "
    "subtle paper grain, clean editorial square poster composition without text, gentle morning shadows, practical slice of life, crisp adult hand details, tidy negative space"
)
...
negative_prompt = (
    ...
    "zipper, wax stick, tool pouch, bicycle, umbrella, photorealistic, horror, muddy colors, overexposed, cluttered crowd, plain white background, flat empty scene, asymmetrical eyes, distorted face"
)
...
webp_path = OUT_DIR / f"nyangdolsoe_shoelace_aglet_cyanotype_nai_{seed}.webp"
...
jpg_path = OUT_DIR / f"nyangdolsoe_shoelace_aglet_cyanotype_nai_{seed}_upload.jpg"
