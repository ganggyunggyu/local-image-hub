...
OUT_DIR = Path(__file__).parent.parent / "outputs" / "20260512_instagram_daily_nyangdolsoe_run3_fridge_gasket"
...
base_prompt = (
    ...
    "standing beside a compact kitchen refrigerator with the door slightly open, square composition, upper body and hands visible, "
    "carefully checking the rubber door gasket with a narrow plain paper strip, wiping crumbs from the gasket groove with a soft cloth, "
    "small bowl of warm water, tiny brush, a few lemon peel pieces on a plate, blank sticky notes with no writing, "
    "miniature server cube sitting on a countertop, focused amused expression, practical everyday maintenance scene, tactile details, "
    "no readable text, no logo, no watermark, masterpiece, best quality"
)
style_suffix = (
    "clean pastel cel-shaded anime illustration, soft aqua and warm butter-yellow palette with muted navy accents, "
    "precise confident linework, gentle translucent shadows, subtle ceramic tile reflections, cozy afternoon kitchen light, "
    "editorial slice of life composition, practical charm, tidy negative space, polished character illustration, detailed hands"
)
...
negative_prompt = (
    ...
    "ghibli, studio ghibli, spray nozzle, scissors, kitchen scale, drawer rail, vending machine, barcode scanner, parcel locker, rice cooker, window sensor, cable tray, "
...
webp_path = OUT_DIR / f"nyangdolsoe_fridge_gasket_pastel_cel_nai_{seed}.webp"
...
jpg_path = OUT_DIR / f"nyangdolsoe_fridge_gasket_pastel_cel_nai_{seed}_upload.jpg"
