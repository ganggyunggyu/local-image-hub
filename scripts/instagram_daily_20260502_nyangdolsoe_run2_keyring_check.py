...
OUT_DIR = Path(__file__).parent.parent / "outputs" / "20260502_instagram_daily_nyangdolsoe_run2"
...
base_prompt = (
    ...
    "blank wooden key tags with absolutely no writing, shallow ceramic dish, folded linen cloth, small unlabeled oil dropper bottle, smooth wall hooks, "
...
payload = {
    ...
    "style": None,
    "save_to_disk": True,
    "filename": "ig_20260502_run2_keyring_check_fresh.webp",
}
...
webp_path = OUT_DIR / f"nyangdolsoe_keyring_check_nai_{seed}.webp"
