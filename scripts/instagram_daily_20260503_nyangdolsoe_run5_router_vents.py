...
OUT_DIR = Path(__file__).parent.parent / "outputs" / "20260503_instagram_daily_nyangdolsoe_run5_router_vents"
...
base_prompt = (
    ...
    "sitting cross legged beside a low shelf at night, gently brushing dust from the ventilation slits of a small plain wifi router with a tiny anti static brush, "
    "soft blue status lights reflected on the shelf, coiled ethernet cable tucked neatly behind, microfiber cloth folded nearby, small dust tray, "
    "quiet focused caretaker expression, practical home network maintenance mood, clear character focus, clean square composition, detailed natural hands, "
    "cozy late night maintenance diary atmosphere, no readable text, no labels, no signage, no logo, no watermark, masterpiece, best quality"
)
style_suffix = (
    "deep navy and soft cyan anime illustration with warm cream accents, thin precise ink linework, subtle gouache and colored pencil texture, "
    "gentle LED glow, tidy negative space, tactile plastic vent slits and brush fibers, polished high resolution rendering, "
    "natural seated pose, small quiet repair ritual, not chibi, not pop art, not poster design"
)
...
payload = {
    ...
    "negative_prompt": (
        ...
        "ghibli, studio ghibli, ethernet text, brand name, qr code, barcode, umbrella, umbrella stand, drip tray, bath robe, wash basin, sink, cat water fountain, pump, moss terrarium, fern, glass terrarium, window track, window rail, cotton swab, key ring, keys, mechanical keyboard, keycap, mouse pad, tablet, charging cable, colored cable tag, cigarette, smoking, apron mending, sewing needle, thread, "
    ...
    "style": None,
    "save_to_disk": True,
    "filename": "ig_20260503_run5_router_vents_fresh.webp",
}
...
webp_path = OUT_DIR / f"nyangdolsoe_router_vents_nai_{seed}.webp"
