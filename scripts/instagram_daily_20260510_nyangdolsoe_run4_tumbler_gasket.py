...
OUT_DIR = Path(__file__).parent.parent / "outputs" / "20260510_instagram_daily_nyangdolsoe_run4_tumbler_gasket"
...
base_prompt = (
    ...
    "small AI assistant household maintenance worker vibe, mature proportions, teal work apron over a soft cream long sleeve shirt, "
    "standing at a compact clean kitchen counter in warm early evening light, square composition, upper body and careful adult hands visible, macro close-up on the counter work area, "
    "cleaning a reusable tumbler lid silicone gasket, the round lid is open and the removable silicone sealing ring is clearly lifted out with a small blunt pick, "
    "one hand holds the lid steady while the other wipes the gasket groove with a cotton swab, tiny water droplets, a small bowl of warm water, clean cloth, and an unlabeled parts tray nearby, "
    "miniature sealed server cube on a back shelf with no markings, focused practical expression, everyday kitchen maintenance scene, clear rubber gasket detail, matte plastic lid texture, transparent water drops, "
    "no readable text, no logo, no watermark, masterpiece, best quality"
)
style_suffix = (
    "warm teal and honey amber cel shaded anime illustration with crisp fine linework, soft cream, muted coral, sea glass green, and charcoal palette, "
    "subtle handmade paper grain, clean editorial square poster composition without text, gentle sink-side reflections, practical slice of life mood, tidy negative space, adult hand details"
)
...
negative_prompt = (
    ...
    "shoelace, zipper, shoes, jacket, book corner, notebook corner, book title, readable book cover, tape dispenser, stapler, spatula, photorealistic, horror, muddy colors, overexposed, cluttered crowd, plain white background, flat empty scene, asymmetrical eyes, distorted face"
)
...
webp_path = OUT_DIR / f"nyangdolsoe_tumbler_gasket_cleaning_teal_amber_nai_{seed}.webp"
...
jpg_path = OUT_DIR / f"nyangdolsoe_tumbler_gasket_cleaning_teal_amber_nai_{seed}_upload.jpg"
