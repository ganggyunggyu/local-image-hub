...
OUT_DIR = Path(__file__).parent.parent / "outputs" / "20260506_instagram_daily_nyangdolsoe_run1_chair_felt"
...
base_prompt = (
    ...
    "crouching beside a wooden chair leg on a calm morning, carefully pressing a new round beige felt floor protector pad onto the bottom of one chair foot, "
    "one worn curled felt pad beside her hand, small pair of scissors, plain dust cloth, warm wood floor, simple chair, soft window light, "
    "quiet practical household maintenance diary mood, focused grown-up caretaker expression, natural hand pose, clear character focus, clean square composition, "
    "no readable text, no labels, no signage, no logo, no watermark, masterpiece, best quality"
)
style_suffix = (
    "clean modern anime illustration with soft gouache-like matte texture, muted sage green and warm honey wood palette, "
    "thin precise linework, gentle cel shading, subtle paper grain, tactile felt fibers and wood grain, uncluttered interior composition, "
    "polished high resolution rendering, not chibi, not poster design, not pop art, not watercolor, not ghibli"
)
...
payload = {
    ...
    "negative_prompt": (
        ...
        "ghibli, studio ghibli, hayao miyazaki, stamp pad, ink pad, spring, eyeglasses, glasses screw, screwdriver, screw tray, camera, lens, lens cap, desiccant pouch, humidity card, door, door hinge, doorknob, door handle, coaster, cup, mug, water ring, wind chime, balcony, router, vent, dust, keyboard, keycap, cable, charger cable, drawer, umbrella, umbrella stand, drip tray, bath robe, wash basin, sink, cat water fountain, pump, moss terrarium, fern, glass terrarium, window track, window rail, cotton swab, key ring, keys, cigarette, smoking, apron mending, sewing needle, thread, "
    ...
    "style": None,
    "save_to_disk": True,
    "filename": "ig_20260506_run1_chair_felt_fresh.webp",
}
...
webp_path = OUT_DIR / f"nyangdolsoe_chair_felt_nai_{seed}.webp"
