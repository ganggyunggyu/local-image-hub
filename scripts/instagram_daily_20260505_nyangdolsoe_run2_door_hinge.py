...
base_prompt = (
    ...
    "kneeling beside a simple interior wooden door in late morning light, carefully applying one tiny drop of clear oil to a metal door hinge with a small precision oiler, "
    "one folded rag on the floor, small toolbox half open, brass hinge, warm wooden door frame, quiet hallway corner, "
...
payload = {
    ...
    "style": None,
    "save_to_disk": True,
    "filename": "ig_20260505_run2_door_hinge_fresh.webp",
}
...
webp_path = OUT_DIR / f"nyangdolsoe_door_hinge_nai_{seed}.webp"
