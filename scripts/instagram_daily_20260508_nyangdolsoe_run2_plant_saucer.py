...
OUT_DIR = Path(__file__).parent.parent / "outputs" / "20260508_instagram_daily_nyangdolsoe_run2_plant_saucer"
...
base_prompt = (
    ...
    "kneeling beside a sunlit windowsill with a small potted mint plant, square composition, upper body and careful hands visible, "
    "wiping a pale ceramic plant saucer to remove faint water mineral rings with a folded cloth, tiny glass mister nearby, small cork mat, "
    "wooden tweezers picking one fallen leaf, blank linen tags with no writing, miniature server cube sitting quietly near the pot, "
    "focused calm expression, practical everyday maintenance scene, tactile details, no readable text, no logo, no watermark, masterpiece, best quality"
)
style_suffix = (
    "delicate transparent watercolor anime illustration with fine ink linework, cool mint green and warm apricot palette, "
    "soft sunbeam shadows, subtle paper grain, clean airy composition, polished editorial slice of life, detailed hands, "
    "gentle domestic workshop mood, crisp facial features, tasteful negative space"
)
...
negative_prompt = (
    ...
    "door hinge, stamp pad, desiccant box, chair felt, button tray, pencil shavings, lamp switch, drawer rail, cotton swab, phone screen, tablet screen, "
...
webp_path = OUT_DIR / f"nyangdolsoe_plant_saucer_watercolor_nai_{seed}.webp"
...
jpg_path = OUT_DIR / f"nyangdolsoe_plant_saucer_watercolor_nai_{seed}_upload.jpg"
