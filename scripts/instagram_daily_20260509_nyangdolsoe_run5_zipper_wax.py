...
OUT_DIR = Path(__file__).parent.parent / "outputs" / "20260509_instagram_daily_nyangdolsoe_run5_zipper_wax"
...
base_prompt = (
    ...
    "sitting at a tidy wooden desk in warm night lamp light, square composition, upper body and careful adult hands visible, "
    "repairing a stuck brass zipper on a small canvas tool pouch, one hand gently holding the zipper pull, the other rubbing a plain beeswax stick along the zipper teeth, "
    "tiny cotton swab, soft cloth, and a small unlabeled maintenance tray nearby, miniature sealed server cube on the back shelf with no markings, calm focused expression, "
    "everyday object maintenance scene, tactile canvas fabric and matte brass details, no readable text, no logo, no watermark, masterpiece, best quality"
)
style_suffix = (
    "soft risograph anime illustration with colored pencil texture, muted terracotta, teal, warm cream, and deep navy palette, "
    "gentle grain, slightly offset ink layers, cozy desk-lamp shadows, clean editorial square poster composition without text, "
...
webp_path = OUT_DIR / f"nyangdolsoe_zipper_wax_risograph_nai_{seed}.webp"
...
jpg_path = OUT_DIR / f"nyangdolsoe_zipper_wax_risograph_nai_{seed}_upload.jpg"
