...
OUT_DIR = Path(__file__).parent.parent / "outputs" / "20260505_instagram_daily_nyangdolsoe_run4_stamp_pad"
...
base_prompt = (
    ...
    "sitting at a compact wooden desk at blue hour, upper body portrait, carefully cleaning an old ink stamp pad mechanism with tiny tweezers, "
    "blank memo papers with no writing, small brass screws, tidy ribbon cable coil, miniature server cube sleeping beside a mug of tea, "
    "gentle focused expression, one hand holding a tiny spring, square composition, intimate everyday maintenance scene, "
    "no readable text, no logo, no watermark, masterpiece, best quality"
)
style_suffix = (
    "layered kirigami paper diorama anime illustration, soft peach and deep teal palette, crisp cel shaded character, "
    "paper cutout shadows, subtle risograph grain, warm desk lamp glow, delicate rim light on cat ears, "
    "quiet whimsical workshop mood, clean shapes, tactile paper texture, polished illustration, calm evening atmosphere"
)
...
negative_prompt = (
    ...
    "phone screen, tablet screen, photorealistic, horror, muddy colors, overexposed, cluttered crowd, chibi proportions, "
    "asymmetrical eyes, distorted face, plain white background, flat empty scene"
)
...
webp_path = OUT_DIR / f"nyangdolsoe_stamp_pad_kirigami_v2_nai_{seed}.webp"
...
jpg_path = OUT_DIR / f"nyangdolsoe_stamp_pad_kirigami_v2_nai_{seed}_upload.jpg"
