...
OUT_DIR = Path(__file__).parent.parent / "outputs" / "20260504_instagram_daily_nyangdolsoe_run1_balcony_wind_chime"
...
base_prompt = (
    ...
    "standing on a small apartment balcony in gentle late morning light, carefully tying a loose string on a tiny glass wind chime hanging from the balcony rail, "
    "one small brass bell, transparent blue glass pieces, a wooden clothespin holding the spare cord, potted rosemary and basil nearby, "
    "soft curtain moving behind the open window, faint city rooftops in the distance, calm focused caretaker expression, "
    "clear character focus, clean square composition, detailed natural hands, airy practical diary mood, no readable text, no labels, no signage, no logo, no watermark, masterpiece, best quality"
)
style_suffix = (
    "warm sepia backlight with pale cyan glass accents, thin precise anime linework, soft watercolor wash and colored pencil grain, "
    "delicate breeze motion in hair ribbon and curtain, tactile cord fibers and glass highlights, polished high resolution rendering, "
    "quiet balcony maintenance ritual, not chibi, not pop art, not poster design"
)
...
payload = {
    ...
    "negative_prompt": (
        ...
        "ghibli, studio ghibli, hayao miyazaki, router, vent, dust, keyboard, keycap, cable, charger cable, drawer, umbrella, umbrella stand, drip tray, bath robe, wash basin, sink, cat water fountain, pump, moss terrarium, fern, glass terrarium, window track, window rail, cotton swab, key ring, keys, cigarette, smoking, apron mending, sewing needle, thread, "
    ...
    "style": None,
    "save_to_disk": True,
    "filename": "ig_20260504_run1_balcony_wind_chime_fresh.webp",
}
...
webp_path = OUT_DIR / f"nyangdolsoe_balcony_wind_chime_nai_{seed}.webp"
