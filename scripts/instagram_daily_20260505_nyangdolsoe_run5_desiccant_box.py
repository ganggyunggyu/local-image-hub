...
OUT_DIR = Path(__file__).parent.parent / "outputs" / "20260505_instagram_daily_nyangdolsoe_run5_desiccant_box"
...
base_prompt = (
    ...
    "sitting beside a low storage shelf at night, carefully replacing a tiny plain cloth desiccant pouch inside a small camera accessory box, "
    "open matte black equipment case, lens cap, soft cleaning cloth, small humidity indicator card with no readable marks, one unlabeled clear jar of spare desiccant beads, "
    "quiet practical storage maintenance diary mood, focused grown-up caretaker expression, natural hand pose, clear character focus, clean square composition, "
    "no readable text, no labels, no signage, no logo, no watermark, masterpiece, best quality"
)
style_suffix = (
    "crisp modern anime illustration with subtle colored pencil texture, deep teal night shadows and muted tangerine desk lamp glow, "
    "thin precise linework, soft cel shading, gentle grain, tactile fabric pouch and matte plastic reflections, uncluttered shelf composition, "
...
payload = {
    ...
    "style": None,
    "save_to_disk": True,
    "filename": "ig_20260505_run5_desiccant_box_fresh.webp",
}
...
webp_path = OUT_DIR / f"nyangdolsoe_desiccant_box_nai_{seed}.webp"
